...
-- ----------------------------
INSERT INTO `blog_article` VALUES (1, 1, 1, 'https://www.static.talkxj.com/articles/1594394792176.jpg', '第一篇文章', '恭喜你，到这一步，你已经运行成功了，到后台编写你的文章吧', '2020-07-10 23:29:01', '2020-07-10 23:29:04', 1, 0, 0);
...
-- ----------------------------
-- Table structure for blog_blog_info
-- ----------------------------
DROP TABLE IF EXISTS `blog_blog_info`;
CREATE TABLE `blog_blog_info`  (
  `id` int(11) NOT NULL,
...
-- ----------------------------
INSERT INTO `blog_category` VALUES (1, '测试', '2020-07-10 23:23:19');
...
-- Records of blog_tag
-- ----------------------------
INSERT INTO `blog_tag` VALUES (1, '文章', '2020-07-10 23:24:04');
...
-- ----------------------------
-- Table structure for blog_user_auth
-- ----------------------------
DROP TABLE IF EXISTS `blog_user_auth`;
CREATE TABLE `blog_user_auth`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of blog_user_auth
-- ----------------------------
INSERT INTO `blog_user_auth` VALUES (1, 1, 'admin@qq.com', '$2a$10$H8QzjW9pFVIlSx8M0n5FoO4FVIS3eja.feH///DoTC9mmMcrAg7kC', 0, '127.0.0.1', '本地局域网', '2020-07-10 23:13:43', '2020-07-10 23:13:44');
...
-- ----------------------------
INSERT INTO `blog_user_info` VALUES (1, 'admin', '博主', 'https://www.static.talkxj.com/avatar/user.png', '开启你的博客', NULL, '2020-07-10 23:14:15', 0);
